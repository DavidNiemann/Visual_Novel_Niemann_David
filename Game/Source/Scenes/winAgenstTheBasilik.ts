namespace VisualNovel {
    export async function theWinAgastTheBasilik(): ƒS.SceneReturn {
        ...
        let storyTexts: { [paragraphName: string]: StoryText } = {
            success: {
                ...
                Protagonist_003: { text: "<i>Der hat mir schwer zugesetzt.</i>", pose: POSES.SAD },
            ...
            end_of_the_mountain: {
                ...
                Protagonist_007: { text: "<i>Endlich dort weg.</i>", pose: POSES.SAD },
